...
- 본문에 마커 포함:
  ...
  🔴**사진 밑에 출처 줄을 달지 마라**(2026-09-22 에디님). 사진마다 «사진: ○○ / Unsplash»가
    붙으면 어디서 퍼온 글처럼 보인다. 무료 스톡(Unsplash) 출처는 **글 맨 끝에 한 줄로만** 모은다.
    ⚠️단 **유튜브·인스타그램 화면을 캡쳐했을 때는 반드시 출처를 넣는다** — 남의 저작물이다.
